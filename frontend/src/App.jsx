      ...
      <nav className="dashboard-nav">
        ...
        {currentUser?.role === "Admin" && (
          <>
            ...
            <button onClick={() => setView('all-appointments')} className={view === 'all-appointments' ? 'active' : ''}>All Appointments</button>
          </>
        )}
        ...
        {currentUser?.role === 'Receptionist' && (
          <>
            <button onClick={() => setView('dashboard')} className={view === 'dashboard' ? 'active' : ''}>Dashboard</button>
            <button onClick={() => setView('appointments-today')} className={view === 'appointments-today' ? 'active' : ''}>Appointments</button>
            <button onClick={() => setView('billing')} className={view === 'billing' ? 'active' : ''}>Billing & Payments</button>
          </>
        )}
        ...
        {currentUser?.role === 'Lab Technician' && (
          <>
            <button onClick={() => setView('dashboard')} className={view === 'dashboard' ? 'active' : ''}>Dashboard</button>
            <button onClick={() => setView('lab-tests')} className={view === 'lab-tests' ? 'active' : ''}>Lab Tests</button>
          </>
        )}
        ...
        {(currentUser?.role === 'Patient') && (
          <>
            <button onClick={() => setView('dashboard')} className={view === 'dashboard' ? 'active' : ''}>Dashboard</button>
            <button onClick={() => setView('available-doctors')} className={view === 'available-doctors' ? 'active' : ''}>All Doctors</button>
            <button onClick={() => setView('book-appointment')} className={view === 'book-appointment' ? 'active' : ''}>Book Appointment</button>
            <button onClick={() => setView('my-appointments')} className={view === 'my-appointments' ? 'active' : ''}>My Appointments</button>
            <button onClick={() => setView('lab-reports')} className={view === 'lab-reports' ? 'active' : ''}>Lab Reports</button>
            <button onClick={() => setView('prescriptions')} className={view === 'prescriptions' ? 'active' : ''}>Prescriptions</button>
          </>
        )}
      </nav>
